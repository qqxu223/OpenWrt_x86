...
luci-app-argon-config luci-app-ddns-go luci-app-openclash luci-app-adblock tcpdump-mini luci-app-nlbwmon luci-app-passwall2 luci-app-wolplus luci-app-vnt luci-app-lucky luci-app-gpsysupgrade \
