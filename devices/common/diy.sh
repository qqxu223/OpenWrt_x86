...
luci-app-wizard luci-base luci-compat luci-lib-ipkg luci-lib-fs luci-app-log-viewer luci-app-vnt luci-app-lucky luci-app-wireguard \
luci-app-argon-config luci-app-ddns-go luci-app-openclash luci-app-adblock tcpdump-mini open-vm-tools wireguard-tools \
