...
luci-app-argon-config luci-app-ddns-go luci-app-openclash luci-app-adblock tcpdump-mini luci-app-nlbwmon luci-app-lucky luci-app-wolplus luci-app-iperf3-server luci-app-vnt luci-app-wireguard luci-app-adguardhome luci-app-dockerman\
